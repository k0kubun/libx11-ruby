module LibX11
  module Xlib
    ...
    attach_function :XSetErrorHandler,    [:XErrorHandler], :XErrorHandler    # L1843
    ...
    attach_function :XNextEvent,          [Display.ptr, XEvent.ptr], :int, blocking: true # L2841
    attach_function :XSelectInput,        [Display.ptr, :Window, :long], :int # L3129
    attach_function :XSync,               [Display.ptr, :Bool], :int, blocking: true # L3409
  end
end
